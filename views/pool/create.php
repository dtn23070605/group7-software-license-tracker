...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0">Add License Pool</h4>
...
<div class="card shadow-sm" style="max-width: 500px;">
    <div class="card-body">
        <form method="POST" action="index.php?module=pool&action=create">
            <div class="mb-3">
                ...
                <select name="software_id" class="form-select" required>
                    ...
                    <?php foreach ($softwareList as $s): ?>
                        <option value="<?= $s['id'] ?>"
                            <?= (($_POST['software_id'] ?? '') == $s['id']) ? 'selected' : '' ?>>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="total_quantity" class="form-control" min="1"
                       value="<?= htmlspecialchars($_POST['total_quantity'] ?? '') ?>" required>
            </div>
            <div class="mb-3">
                ...
                <input type="number" name="available_quantity" class="form-control" min="0"
                       value="<?= htmlspecialchars($_POST['available_quantity'] ?? '') ?>" required>
